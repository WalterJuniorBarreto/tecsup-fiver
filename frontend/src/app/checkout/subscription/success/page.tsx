        ...
        <div className="max-w-xl w-full bg-[#121214] border border-zinc-800/80 rounded-[3rem] p-10 md:p-14 text-center shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-500">
          ...
          {isProcessing ? (
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <h2 className="text-2xl font-black mb-2">Activando tu plan {plan}...</h2>
              <p className="text-zinc-500 text-sm">Estamos configurando tus nuevos superpoderes. Por favor espera unos segundos.</p>
            </div>
          ) : (
            <div className="flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#00e676]/10 border border-[#00e676]/20 text-[#00e676] text-xs font-black uppercase tracking-widest mb-6">
                <Crown size={14} /> Pago Exitoso
              </div>

              <h1 className="text-4xl md:text-5xl font-black mb-4 tracking-tight">¡Bienvenido al nivel {plan}!</h1>
              
              <p className="text-zinc-400 mb-10 leading-relaxed">
                Tu pago se ha procesado correctamente. Ahora tienes acceso a herramientas premium, menor comisión y mayor visibilidad en DevMarket.
              </p>
              ...
              <div className="w-full space-y-4">
                ...
                >
                  Ir a mi panel de membresía <ArrowRight size={18} strokeWidth={3} />
                </Link>
                
                <Link 
                  href="/explore" 
                  className="w-full py-4 bg-[#0a0a0a] text-zinc-300 rounded-xl font-bold text-sm border border-zinc-800 hover:text-white hover:bg-zinc-900 transition-colors flex items-center justify-center"
                >
                  Explorar el mercado
                </Link>
              </div>
