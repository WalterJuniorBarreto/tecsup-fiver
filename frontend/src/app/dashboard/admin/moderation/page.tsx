...
export default function AdminModerationPage() {
  ...
  return (
    <div className="grid grid-cols-[auto_1fr] min-h-screen bg-[#0a0a0a] text-white selection:bg-[#00e676]/30 w-full">
      {/* Barra lateral fija en su columna auto-calculada */}
      <AdminSidebar />

      {/* Contenedor principal centrado de forma fluida */}
                  ...
                  <div className="flex-1 flex flex-col">
                    <div className="flex items-center justify-between mb-4">
                      <div className="text-xs text-zinc-500 font-medium flex items-center gap-2">
                        ...
                        <span>Reportado por <span className="font-bold text-zinc-300">{report.reporterName}</span></span>
                      </div>
